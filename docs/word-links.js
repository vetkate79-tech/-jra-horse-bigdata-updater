...
function resetOrphanDictionaryBlue(){
  for(const el of document.body.querySelectorAll('*')){
    ...
    if(DICTIONARY_BLUES.has(getComputedStyle(el).color))el.classList.add('jra-orphan-blue-reset');
  }
}
async function init(){
  css();

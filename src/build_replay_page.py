...
<script>{js}</script><script src="/-jra-horse-bigdata-updater/word-links.js"></script></body></html>'''
    ...
    checks={
        ...
        "hidden_state_css_guard":'[hidden]{display:none!important}' in page,
        "only_active_filter_groups_visible_by_default":page.count('class="dates date-group" data-month="'+open_month+'"')==1
    }
